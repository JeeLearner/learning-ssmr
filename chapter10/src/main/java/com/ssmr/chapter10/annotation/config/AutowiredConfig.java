...
@ComponentScan(basePackages = { "com.ssmr.chapter10.*" }, excludeFilters = {
		@Filter(type = FilterType.REGEX, pattern = "com.ssmr.chapter10.annotation.config.ApplicationConfig") })
